...
//nolint:gocognit
func genIdx(fpath string) { //nolint:cyclop
	type Index struct {
		Name          string
		NameShort     string
		ResType       string
...
func genDoc(dtype, dtypeFolder, fpath, name string, resource *schema.Resource) { //nolint:cyclop
...
//nolint:gocognit
func getSubStruct(step int, k string, v *schema.Schema) []string { //nolint:cyclop
